  ...
  return (
    <AppLayoutWrapper>
      <div className="flex min-h-full flex-col p-6 md:p-8">
        ...
        <header className="mb-6 shrink-0 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-200 pb-6">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              Histórico Cronológico e Auditoria Geral de Operações.
            </p>
          </div>
        ...
        {erro && (
          <div className="mb-6 shrink-0 rounded border-l-4 border-red-500 bg-red-50 p-4 font-semibold text-red-800 shadow-sm break-words">
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right font-black text-gray-900">
                        {new Intl.NumberFormat('pt-BR', { 
                          style: 'currency', 
                          currency: 'BRL' 
                        }).format(Number(comanda.valor_total) || 0)}
                      </td>
                    </tr>
                  ))
                )}
