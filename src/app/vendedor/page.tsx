        ...
        <header className="mb-6 shrink-0 flex flex-col gap-4 border-b border-gray-200 pb-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 rounded-full bg-blue-100 px-4 py-2 text-sm font-bold text-blue-800 shadow-sm border border-blue-200">
              ...
              {isGestor ? 'Auditoria Ativa' : 'Vendedor Ativo'}
            </div>
          </div>
          ...
          <div className="mb-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 shrink-0">
            <div className="rounded-xl border border-green-200 bg-white p-5 shadow-sm relative overflow-hidden">
              ...
              <h3 className="text-sm font-bold text-gray-500 mb-1">
                Vendas Expressas (Total)
              </h3>
              <p className="text-2xl font-black text-green-700">
                {new Intl.NumberFormat('pt-BR', { 
                  style: 'currency', 
                  currency: 'BRL' 
                }).format(totalRendimentoVendas)}
              </p>
              <p className="text-xs font-semibold text-green-600 mt-2">
                {vendasExpressas.length} pedidos finalizados
              </p>
            </div>
            ...
            <div className="rounded-xl border border-red-200 bg-white p-5 shadow-sm relative overflow-hidden">
              ...
              <p className="text-xs font-semibold text-red-500 mt-2">
                Registradas pelo operador
              </p>
            </div>
          </div>

          <div className="rounded-xl border border-gray-200 bg-white shadow-sm flex flex-col shrink-0 overflow-hidden">
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <span 
                            ...
                            style={{ 
                              color: comanda.cor_hexadecimal, 
                              borderColor: `${comanda.cor_hexadecimal}40`, 
                              backgroundColor: `${comanda.cor_hexadecimal}10` 
                            }}
                          >
