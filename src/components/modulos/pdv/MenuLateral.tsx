  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div 
            className="flex w-10 justify-center shrink-0"
          >
            <span 
              className="text-2xl font-black text-blue-500 group-hover:hidden transition-all"
            >
              W
            </span>
            <span 
              className="text-2xl font-black text-blue-500 hidden group-hover:block transition-all"
            >
      ...
      >
        ...
        >
          ...
          >
            <p 
              className="text-sm font-bold text-white truncate max-w-[160px]"
            >
              {usuarioDb?.nome_completo || 'Operador'}
            </p>
            <span 
              className="text-[10px] font-bold uppercase tracking-wider text-blue-400 mt-0.5"
            >
              {perfilRbac}
            </span>
          </div>
